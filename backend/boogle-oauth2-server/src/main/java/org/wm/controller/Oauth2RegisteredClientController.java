...
public class Oauth2RegisteredClientController extends BaseController {
    ...
    public PageResult<Oauth2RegisteredClientDto> list(Oauth2RegisteredClient oauth2RegisteredClient) {
        startPage();
        List<Oauth2RegisteredClient> list = oauth2RegisteredClientService.selectOauth2RegisteredClientList(oauth2RegisteredClient);
        var resList = list.stream().map(ele -> {
        ...
        return getDataTable(resList, list);
    }
